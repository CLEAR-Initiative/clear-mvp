...
export function MapLoadingOverlay({ dataView }: MapLoadingOverlayProps) {
  ...
  return (
    ...
    >
      ...
      >
        <svg viewBox="0 0 227 227.7" style={{ width: "100%", height: "100%" }}>
          ...
          <path
            fill="#FFFFFF"
            d="M108.4,176.2H91.6V97.4h26.8c21.2,0,28.5,9.7,28.1,24.7c-0.4,13.5-5.4,17.2-13.7,21.2l19.3,32.9h-19.6
          ...
          <path
            fill="#FFFFFF"
            d="M185.5,95.9c9.1,0,13.2,1.7,16.4,2.9v15.9c-4.6-2.1-9.6-3.1-14.7-3c-12.8,0-18.7,5.1-18.7,25.1
